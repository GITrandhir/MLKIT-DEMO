...
import com.randhir.mlkitdemo.Helper.GraphicOverlay;
import com.randhir.mlkitdemo.Helper.RectOverlay;
...
public class FaceDActivity extends AppCompatActivity {
    ...
    private void processFaceDetection(Bitmap bitmap) {
        ...
        firebaseVisionFaceDetector.detectInImage(firebaseVisionImage)
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(FaceDActivity.this,"Error : " + e.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
    }
